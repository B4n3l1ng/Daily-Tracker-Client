      ...
      {list.map((character) => (
        ...
        >
          <Flex minW="50%" justifyContent={'space-evenly'} gap="1em" alignContent={'center'}>
            ...
            <Text minW="50%">Level {character.level}</Text>
          </Flex>
          <Flex minW="50%" justifyContent={'space-evenly'} gap="1em" alignContent={'center'}>
            <Link to={`/character/${character._id}`}>
              <Button size="sm" minW="45%" colorScheme="yellow">
                Dailies
              </Button>
            </Link>
            <Button colorScheme="red" size="sm" minW="45%" onClick={() => deleteCharacter(character._id)}>
              Delete
            </Button>
          </Flex>
        </Flex>
